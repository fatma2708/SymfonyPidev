...
class __TwigTemplate_4400afd982f0637f6fdc1fd2a97c864c extends Template
{
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_equipement_delete', {'id': equipement.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ equipement.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "equipement/_delete_form.html.twig", "C:\\Users\\fatma\\symfonypidev\\templates\\equipement\\_delete_form.html.twig");
    }
}
