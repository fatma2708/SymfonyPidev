...
class __TwigTemplate_819100cb7715daca1b207deabc37e0ca extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h1>Create new Equipement</h1>
...
{% block title %}New Equipement{% endblock %}

{% block body %}
    <h1>Create new Equipement</h1>

    {{ include('equipement/_form.html.twig') }}

    <a href=\"{{ path('app_equipement_index') }}\">back to list</a>
{% endblock %}
", "equipement/new.html.twig", "C:\\Users\\fatma\\symfonypidev\\templates\\equipement\\new.html.twig");
    }
}
