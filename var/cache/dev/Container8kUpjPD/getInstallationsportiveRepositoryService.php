 ...
 */
class getInstallationsportiveRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InstallationsportiveRepository' shared autowired service.
     *
     * @return \App\Repository\InstallationsportiveRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InstallationsportiveRepository.php';

        return $container->privates['App\\Repository\\InstallationsportiveRepository'] = new \App\Repository\InstallationsportiveRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
