 ...
 */
class getMatchsportifRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MatchsportifRepository' shared autowired service.
     *
     * @return \App\Repository\MatchsportifRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MatchsportifRepository.php';

        return $container->privates['App\\Repository\\MatchsportifRepository'] = new \App\Repository\MatchsportifRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
