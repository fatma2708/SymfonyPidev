...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\BlessureType' => ['privates', 'App\\Form\\BlessureType', 'getBlessureTypeService', true],
            'App\\Form\\DossiermedicalType' => ['privates', 'App\\Form\\DossiermedicalType', 'getDossiermedicalTypeService', true],
            'App\\Form\\EntrainmentType' => ['privates', 'App\\Form\\EntrainmentType', 'getEntrainmentTypeService', true],
            ...
            'App\\Form\\InstallationsportiveType' => ['privates', 'App\\Form\\InstallationsportiveType', 'getInstallationsportiveTypeService', true],
            'App\\Form\\MatchsportifType' => ['privates', 'App\\Form\\MatchsportifType', 'getMatchsportifTypeService', true],
            'App\\Form\\PerformanceathleteType' => ['privates', 'App\\Form\\PerformanceathleteType', 'getPerformanceathleteTypeService', true],
            'App\\Form\\PerformanceequipeType' => ['privates', 'App\\Form\\PerformanceequipeType', 'getPerformanceequipeTypeService', true],
            'App\\Form\\TournoisType' => ['privates', 'App\\Form\\TournoisType', 'getTournoisTypeService', true],
            ...
            'App\\Form\\BlessureType' => '?',
            'App\\Form\\DossiermedicalType' => '?',
            'App\\Form\\EntrainmentType' => '?',
            'App\\Form\\EquipeType' => '?',
            'App\\Form\\EquipementType' => '?',
            'App\\Form\\ExerciceType' => '?',
            'App\\Form\\InstallationsportiveType' => '?',
            'App\\Form\\MatchsportifType' => '?',
            'App\\Form\\PerformanceathleteType' => '?',
            'App\\Form\\PerformanceequipeType' => '?',
            'App\\Form\\TournoisType' => '?',
