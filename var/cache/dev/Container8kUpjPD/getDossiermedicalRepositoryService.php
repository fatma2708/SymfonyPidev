 ...
 */
class getDossiermedicalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DossiermedicalRepository' shared autowired service.
     *
     * @return \App\Repository\DossiermedicalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DossiermedicalRepository.php';

        return $container->privates['App\\Repository\\DossiermedicalRepository'] = new \App\Repository\DossiermedicalRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
