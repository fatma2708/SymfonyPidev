 ...
 */
class getExerciceEntrainmentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Exercice_entrainmentRepository' shared autowired service.
     *
     * @return \App\Repository\Exercice_entrainmentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Exercice_entrainmentRepository.php';

        return $container->privates['App\\Repository\\Exercice_entrainmentRepository'] = new \App\Repository\Exercice_entrainmentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
