 ...
 */
class getPerformanceathleteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PerformanceathleteRepository' shared autowired service.
     *
     * @return \App\Repository\PerformanceathleteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PerformanceathleteRepository.php';

        return $container->privates['App\\Repository\\PerformanceathleteRepository'] = new \App\Repository\PerformanceathleteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
