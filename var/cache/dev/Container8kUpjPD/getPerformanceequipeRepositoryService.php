 ...
 */
class getPerformanceequipeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PerformanceequipeRepository' shared autowired service.
     *
     * @return \App\Repository\PerformanceequipeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PerformanceequipeRepository.php';

        return $container->privates['App\\Repository\\PerformanceequipeRepository'] = new \App\Repository\PerformanceequipeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
