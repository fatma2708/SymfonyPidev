 ...
 */
class getEntrainmentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EntrainmentRepository' shared autowired service.
     *
     * @return \App\Repository\EntrainmentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntrainmentRepository.php';

        return $container->privates['App\\Repository\\EntrainmentRepository'] = new \App\Repository\EntrainmentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
