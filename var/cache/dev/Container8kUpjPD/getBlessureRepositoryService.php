 ...
 */
class getBlessureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BlessureRepository' shared autowired service.
     *
     * @return \App\Repository\BlessureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BlessureRepository.php';

        return $container->privates['App\\Repository\\BlessureRepository'] = new \App\Repository\BlessureRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
