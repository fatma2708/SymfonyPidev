...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\BlessureController' => 'getBlessureControllerService',
            'App\\Controller\\DossiermedicalController' => 'getDossiermedicalControllerService',
            'App\\Controller\\EntrainmentController' => 'getEntrainmentControllerService',
            'App\\Controller\\EquipeController' => 'getEquipeControllerService',
            'App\\Controller\\EquipementController' => 'getEquipementControllerService',
            'App\\Controller\\ExerciceController' => 'getExerciceControllerService',
            'App\\Controller\\InstallationsportiveController' => 'getInstallationsportiveControllerService',
            'App\\Controller\\LandingController' => 'getLandingControllerService',
            'App\\Controller\\MatchsportifController' => 'getMatchsportifControllerService',
            'App\\Controller\\PerformanceathleteController' => 'getPerformanceathleteControllerService',
            'App\\Controller\\PerformanceequipeController' => 'getPerformanceequipeControllerService',
            'App\\Controller\\TournoisController' => 'getTournoisControllerService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dh2Ub4ge32', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('luh9sbSn60', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lY-cYY6hYP', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\BlessureController', 'App\\Controller\\DossiermedicalController', 'App\\Controller\\EntrainmentController', 'App\\Controller\\EquipeController', 'App\\Controller\\EquipementController', 'App\\Controller\\ExerciceController', 'App\\Controller\\InstallationsportiveController', 'App\\Controller\\LandingController', 'App\\Controller\\MatchsportifController', 'App\\Controller\\PerformanceathleteController', 'App\\Controller\\PerformanceequipeController', 'App\\Controller\\TournoisController', 'App\\Controller\\UtilisateurController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wxiwHgweK2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('3iHIMeZa4j', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aKYzfbIio6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yZWWQqp4FJ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VEi48qr+vs', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3UIHkQ0BOL', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\BlessureRepository' => ['privates', 'App\\Repository\\BlessureRepository', 'getBlessureRepositoryService', true],
            'App\\Repository\\DossiermedicalRepository' => ['privates', 'App\\Repository\\DossiermedicalRepository', 'getDossiermedicalRepositoryService', true],
            'App\\Repository\\EntrainmentRepository' => ['privates', 'App\\Repository\\EntrainmentRepository', 'getEntrainmentRepositoryService', true],
            ...
            'App\\Repository\\Exercice_entrainmentRepository' => ['privates', 'App\\Repository\\Exercice_entrainmentRepository', 'getExerciceEntrainmentRepositoryService', true],
            'App\\Repository\\InstallationsportiveRepository' => ['privates', 'App\\Repository\\InstallationsportiveRepository', 'getInstallationsportiveRepositoryService', true],
            'App\\Repository\\MatchsportifRepository' => ['privates', 'App\\Repository\\MatchsportifRepository', 'getMatchsportifRepositoryService', true],
            'App\\Repository\\PerformanceathleteRepository' => ['privates', 'App\\Repository\\PerformanceathleteRepository', 'getPerformanceathleteRepositoryService', true],
            'App\\Repository\\PerformanceequipeRepository' => ['privates', 'App\\Repository\\PerformanceequipeRepository', 'getPerformanceequipeRepositoryService', true],
            'App\\Repository\\TournoisRepository' => ['privates', 'App\\Repository\\TournoisRepository', 'getTournoisRepositoryService', true],
            'App\\Repository\\UtilisateurRepository' => ['privates', 'App\\Repository\\UtilisateurRepository', 'getUtilisateurRepositoryService', true],
        ], [
            'App\\Repository\\BlessureRepository' => '?',
            'App\\Repository\\DossiermedicalRepository' => '?',
            'App\\Repository\\EntrainmentRepository' => '?',
            'App\\Repository\\EquipeRepository' => '?',
            'App\\Repository\\EquipementRepository' => '?',
            'App\\Repository\\ExerciceRepository' => '?',
            'App\\Repository\\Exercice_entrainmentRepository' => '?',
            'App\\Repository\\InstallationsportiveRepository' => '?',
            'App\\Repository\\MatchsportifRepository' => '?',
            'App\\Repository\\PerformanceathleteRepository' => '?',
            'App\\Repository\\PerformanceequipeRepository' => '?',
            'App\\Repository\\TournoisRepository' => '?',
