 ...
 */
class getTournoisRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TournoisRepository' shared autowired service.
     *
     * @return \App\Repository\TournoisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TournoisRepository.php';

        return $container->privates['App\\Repository\\TournoisRepository'] = new \App\Repository\TournoisRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
