 ...
 */
class getEquipeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EquipeRepository' shared autowired service.
     *
     * @return \App\Repository\EquipeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EquipeRepository.php';

        return $container->privates['App\\Repository\\EquipeRepository'] = new \App\Repository\EquipeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
